defmodule AshcrudWeb.Components.CheckboxCard do
  @moduledoc """
  The `AshcrudWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
