defmodule AshcrudWeb.Components.NativeSelect do
  @moduledoc """
  The `AshcrudWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `AshcrudWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AshcrudWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AshcrudWeb.Gettext, "errors", msg, opts)
    end
  end
end
