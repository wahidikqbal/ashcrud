defmodule AshcrudWeb.Components.Clipboard do
  @moduledoc """
  The `AshcrudWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
