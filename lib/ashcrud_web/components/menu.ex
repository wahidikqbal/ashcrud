defmodule AshcrudWeb.Components.Menu do
  @moduledoc """
  The `AshcrudWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `AshcrudWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import AshcrudWeb.Components.Button, only: [button_link: 1]
