defmodule AshcrudWeb.Components.Spinner do
  @moduledoc """
  The `AshcrudWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `AshcrudWeb.Components.Spinner` module enables developers to provide
