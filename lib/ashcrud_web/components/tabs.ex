defmodule AshcrudWeb.Components.Tabs do
  @moduledoc """
  `AshcrudWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import AshcrudWeb.Components.Badge, only: [badge: 1]
