defmodule AshcrudWeb.Components.ScrollArea do
  @moduledoc """
  The `AshcrudWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
